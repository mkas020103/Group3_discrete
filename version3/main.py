...
#Set App Icon
root.iconbitmap(r'C:\Users\mdfl0\Desktop\version2\filterio.ico')
...
image_file = format(file_path.get())
...
# Create enter button
enter = tk.Button(frame1, text="Enter", font=('Arial', 11), command = on_click())
enter.pack(padx=22, pady=(8, 1))

#Buttons

# Create blur button
blur = tk.Button(frame3, text="Blur", font=('Arial', 11), command = blur())
...
quit = tk.Button(frame1, text="Quit", command=root.destroy, bg='red')
